...
const form = useForm({
    tournament_id: props.tournament_official.tournament_id || "",
    official_role_code: props.tournament_official.official_role_code || "",
    name: props.tournament_official.name || "",
    country_code: props.tournament_official.country_code || "",
});

const submit = () => {
    form.clearErrors();
    form.put(
        route("tournament-officials.update", props.tournament_official.id),
        {
            preserveScroll: true,
        }
    );
...
const breadcrumbs = [
    ...
    {
        title: "Ubah Official",
        href: route("tournament-officials.edit", props.tournament_official.id),
    },
];
</script>

<template>
    <Head title="Ubah Official" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <AppMain>
            <div
                class="flex flex-col md:flex-row md:justify-between md:items-center gap-4"
            >
                <h2 class="text-lg md:text-xl font-bold">Ubah Official</h2>
            </div>
